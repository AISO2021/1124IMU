...
#imuのヨーレートとautowareのヨーレートを比較するプログラム
import threading
import time
import collections
import numpy as np
...
if __name__ == '__main__':
    ...
    try:
        ...
        while not rospy.is_shutdown():  # rospy.spin()と同じ
            ...
            #speed = a.get_speed()
            speed = 0.5
            #imu_ang = comp_corner(imu_ang, comp_ang)
            print("ang-of-imu",imu_ang)
            print("ang-of-autoware",autoware_ang)
